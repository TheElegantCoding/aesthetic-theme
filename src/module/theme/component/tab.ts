...
const getTab = (colors: Palette) => {
  ...
  return {
    'editorGroupHeader.tabsBackground': background.background_950,
    'editorGroupHeader.tabsBorder': base.transparent,
    'editorGroupHeader.noTabsBackground': background.background_950,
    'editorGroup.dropBackground': alpha(background.background_950, 0.9),
    ...
    'tab.inactiveBackground': background.background_950,
    ...
    'tab.unfocusedInactiveBackground': background.background_950,
